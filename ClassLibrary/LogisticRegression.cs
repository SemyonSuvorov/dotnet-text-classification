...
public class LogisticRegression
{
    ...
    public double PredictProbaForOneSample(List<double> feature)
    {
        ...
        {
            throw new Exception("Shape of feature must be equal to shape of feature in train df");
        }
        //add bias term
        feature.Insert(0, 1.0);
        var yPred = Sigmoid(Vector<double>.Build.DenseOfEnumerable(feature) * _weights);
        return yPred;
    }
